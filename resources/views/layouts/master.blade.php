			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="{{route('category_Tehno')}}">Стоматологическая техника</a></li>

						
						<li><a href="{{route('category_Tooth')}}">Стоматологические материалы</a></li>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<span class="copyright">
								...
								ZTehno &copy;<script>document.write(new Date().getFullYear());</script> Мы всегда с вами 
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</span>
						</div>
					</div>
